...
Route::middleware('auth')->group(function () {
    ...
    Route::get('my-tasks/export', [TaskController::class, 'myTasksExport'])->name('tasks.my_tasks.export');
    Route::get('my-tasks', [TaskController::class, 'myTasks'])->name('tasks.my_tasks.index');
